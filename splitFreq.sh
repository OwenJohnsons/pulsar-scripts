...
pfitsUtil_searchmode_extractFreq -f $file -o frequency_split/${output_name}_0.7-1.9GHz.sf -c1 0 -c2 4865
pfitsUtil_searchmode_extractFreq -f $file -o frequency_split/${output_name}_1.9-3.0GHz.sf -c1 4866 -c2 9392
pfitsUtil_searchmode_extractFreq -f $file -o frequency_split/${output_name}_3.0-4.0GHz.sf -c1 9393 -c2 13312